# This file will use the Tweepy Cursor API to reply to mentions, 
...
# Define a check_mentions function that accepts api, keywords, and since_id,
# follow and reply to the user if user has mentioned us
